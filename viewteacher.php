...
<div class="c-eighteen" >
    ...
    <div class="right">
        <h3>viewteacher.php</h3>
        <p>our teachers data show here.</p>
        <table style="text-align:center; margin:0 auto;">
            <tr style="border:1px solid skyblue; font-weight:800;">
                <td style="background-color:cadetblue;">id</td>
                <td style="background-color:coral;">username</td>
                <td style="background-color:cadetblue;">Description</td>
                <td style="background-color:coral;">image</td>
            ...
            <tr style="border:1px solid skyblue;">
                ...
                <td style="background-color:cadetblue;"><?php echo $row['description'];?></td>
                <td><img style="width:70px; height:40px;"src="<?php echo $row['image'];?>" alt=""></td>
                <td>
                    <a class="btn btn-warning" href='editteacher.php?action=edit&id=<?php echo $row['id'];?>'>edit</a>
                </td>
                <td>
                    <a onclick="return confirmbox();" class="btn btn-danger"href="editteacher.php?action=delete&id=<?php echo $row['id'];?>">delete</a>
                </td>
            </tr>
            <?php
            }
